<nav class="sidebar sidebar-offcanvas dynamic-active-class-disabled" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item {{ active_class(['masterdata/*']) }}">
      <a class="nav-link" data-toggle="collapse" href="#masterdata" aria-expanded="{{ is_active_route(['masterdata/*']) }}" aria-controls="masterdata">
        <i class="menu-icon mdi mdi-dna"></i>
        <span class="menu-title">Master Data</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse {{ show_class(['masterdata/*']) }}" id="masterdata">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item {{ active_class(['masterdata/kelurahan']) }}">
            <a class="nav-link" href="{{ url('/masterdata/kelurahan') }}">kelurahan</a>
          </li>
          <li class="nav-item {{ active_class(['basic-ui/dropdowns']) }}">
            <a class="nav-link" href="{{ url('/basic-ui/dropdowns') }}">Dropdowns</a>
          </li>
